    ...
    <div className="flex flex-col md:flex-row md:items-center gap-4 mb-8">
      <div className="flex items-center space-x-2">
        ...
        <Select onValueChange={(value) => {console.log("category changed"); setCategory(value === "all" ? null : value)}}>
          ...
          <SelectContent>
          <SelectItem value="all" className="border-l-4 border-red-500 pl-3">
                <span className="text-red-600">All</span>
            </SelectItem>
            <SelectItem value="Road Damage" className="border-l-4 border-red-500 pl-3">
                <span className="text-red-600">Road Damage</span>
            </SelectItem>

            <SelectItem value="Water Leakage" className="border-l-4 border-blue-500 pl-3">
                <span className="text-blue-600">Water Leakage</span>
            </SelectItem>

            <SelectItem value="Garbage Collection" className="border-l-4 border-green-500 pl-3">
                <span className="text-green-600">Garbage Collection</span>
            </SelectItem>

            <SelectItem value="Street Lights" className="border-l-4 border-yellow-500 pl-3">
                <span className="text-yellow-600">Street Lights</span>
            </SelectItem>

            <SelectItem value="Traffic Signals" className="border-l-4 border-orange-500 pl-3">
                <span className="text-orange-600">Traffic Signals</span>
            </SelectItem>

            <SelectItem value="Illegal Construction" className="border-l-4 border-purple-500 pl-3">
                <span className="text-purple-600">Illegal Construction</span>
            </SelectItem>

            <SelectItem value="Sewage Issues" className="border-l-4 border-teal-500 pl-3">
                <span className="text-teal-600">Sewage Issues</span>
            </SelectItem>

            <SelectItem value="Noise Pollution" className="border-l-4 border-pink-500 pl-3">
            ...
            <SelectItem value="Internet & Telecom Issues" className="border-l-4 border-cyan-500 pl-3">
